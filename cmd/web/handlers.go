...
func (app *application) GetTransactionData(r *http.Request) (TransactionData, error) {
	...
	//cardHolder := r.Form.Get("cardholder")
...
func (app *application) PaymentSuccess(w http.ResponseWriter, r *http.Request) {
	...
	//write data to the session and redirect
...
//VirtualTerminalPaymentSuccess shows success page for transactions
...
//ChargeOnce displays the buy one widget page
...
//ForgotPassword displays the forgot password reset page
...
func (app *application) ShowResetPassword(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		app.errorLog.Println(err)
		w.Write([]byte("Encrypption failed"))
		return
	}
...
func (app *application) ShowSale(w http.ResponseWriter, r *http.Request) {
	...
	stringMap["refund-status"] = "Refunded"
...
func (app *application) ShowSubscription(w http.ResponseWriter, r *http.Request) {
	...
	stringMap["refund-status"] = "Canceled"
...
//AllUsers shows all the users' info
